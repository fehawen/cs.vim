...
call s:hi("typescriptRepeat",                  s:cterm.blue_bright,      "",                       "")
call s:hi("typescriptNodeGlobal",              s:cterm.blue_bright,      "",                       "")
call s:hi("typescriptBOMNavigatorProp",        s:cterm.blue_bright,      "",                       "")
call s:hi("typescriptBOMWindowProp",           s:cterm.blue_bright,      "",                       "")
call s:hi("typescriptDOMFormProp",             s:cterm.blue_bright,      "",                       "")
call s:hi("typescriptDOMDocMethod",            s:cterm.blue_bright,      "",                       "")
call s:hi("typescriptArrayStaticMethod",       s:cterm.blue_bright,      "",                       "")
call s:hi("typescriptArrayMethod",             s:cterm.blue_bright,      "",                       "")
call s:hi("typescriptJSONStaticMethod",        s:cterm.blue_bright,      "",                       "")
call s:hi("typescriptStringMethod",            s:cterm.blue_bright,      "",                       "")
call s:hi("typescriptHeadersMethod",           s:cterm.blue_bright,      "",                       "")
call s:hi("typescriptGlobalMethod",            s:cterm.blue_bright,      "",                       "")
