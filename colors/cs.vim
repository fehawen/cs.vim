...
call s:hi("ColorColumn",                       s:cterm.background,       s:cterm.red_bright,       "")
...
call s:hi("typescriptExport",                  s:cterm.blue_dim,         "",                       "BOLD")
...
call s:hi("typescriptTypeBracket",             s:cterm.cyan_bright,      "",                       "BOLD")
call s:hi("typescriptTypeReference",           s:cterm.yellow_dim,       "",                       "BOLD")
...
call s:hi("typescriptMember",                  s:cterm.cyan_bright,      "",                       "BOLD")
call s:hi("typescriptMemberOptionality",       s:cterm.magenta_dim,      "",                       "")
call s:hi("typescriptPred_brightefinedType",   s:cterm.yellow_dim,       "",                       "BOLD")
...
call s:hi("typescriptAliasKeyword",            s:cterm.blue_dim,         "",                       "BOLD")
call s:hi("typescriptInterfaceName",           s:cterm.yellow_dim,       "",                       "BOLD")
call s:hi("typescriptAliasDeclaration",        s:cterm.yellow_dim,       "",                       "BOLD")
...
call s:hi("typescriptGlobal",                  s:cterm.blue_dim,         "",                       "BOLD")
